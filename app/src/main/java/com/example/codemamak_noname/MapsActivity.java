...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(markerDemokPark).title("Demokrasi Parkı").snippet("Demokrasi parkındaki bankları seç!"));
        mMap.addMarker(new MarkerOptions().position(markerKutuphane).title("Ege Mahallesi Halk Kütüphanesi").snippet("Kütüphanenin tabelası değişecek. Nasıl olsun?"));
        mMap.addMarker(new MarkerOptions().position(markerDinlenPark).title("Dinlenme Parkı").snippet("En güzel çocuk parkını seçmemiz için bize yardım et!"));
